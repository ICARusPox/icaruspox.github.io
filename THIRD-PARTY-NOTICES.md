...
This document contains license and copyright notices for third-party software components incorporated into the ICARusPox project repository.

---

## BioJS Ecosystem (`js/biojs-bundle.js`)

- **Component Name**: BioJS
- **Project Repository**: [https://github.com/biojs/biojs](https://github.com/biojs/biojs)
- **License**: Apache License 2.0
- **Copyright**: Copyright (c) BioJS Community / Contributors
...
```text
   ...
   3. Grant of Patent License. Subject to the terms and conditions of
      ...
      Contribution(s) alone or in combination with their Work to which such
